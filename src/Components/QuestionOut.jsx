            ...
            <div className='question-paper-main-container'>
                <div className='w-100  d-flex p-3 m-1 '>
                    <div className='ms-auto'>
                        ...
                        <i className="mx-1 btn btn-warning d-p-icon ri-printer-line " onClick={handlePrint}></i>
                    </div>
                </div>
                <div className='Qs-container'>
                    <div className='question_paper' ref={printRef}>
                        {/*    ---------------------------------------------- WATER MARK--------------------------------- */}
                        ...
                        <div ref={questionRef} className='d-flex justify-content-center align-items-center flex-column '>
                            ...
                            <div className="section">
                                {local_question_details?.short_key != 0 ? <div style={{ width: '100%' }} >
                                    ...
                                    {data.short_key.length > local_question_details.short_key ?
                                        ...
                                        : "We don't have Enofgh questins -_-"}
                                </div> : ""}
                            </div>
                            {/* ------------------------------------TWO MARK PART-------------------------------------- */}
                            ...
                            <div className="section">
                                {local_question_details?.two_mark != 0 ? <div style={{ width: '100%' }}>
                                    ...
                                    {data.two_mark.length > local_question_details.two_mark ?
                                        <div>
                            ...
                            <div className='section'>
                                {local_question_details.five_mark != 0 ? <div style={{ width: '100%' }}>
                                    ...
                                    {data.five_mark.length > local_question_details.five_mark ? <div style={{ width: "90%" }}>
                                    ...
                                    </div> : "We don't have Enofgh questins -_-"}
                                </div> : ""}
                            </div>
                            {/* ------------------------------------TEN MARK PART-------------------------------------- */}
                            ...
                            <div className='section'>
                                {local_question_details.ten_mark != 0 ?
                                    <div style={{ width: '100%' }}>
                                        ...
                                        {data.ten_mark.length > local_question_details.ten_mark ? <div style={{ width: "90%" }}>
                            ...
                            <div className='section'>
                                {local_question_details.prac > local_question_details.prac ?
                                    <div style={{ width: '100%' }}>
                                        ...
                                        {data.prac.length > local_question_details.prac ? <div style={{ width: "90%" }}>
